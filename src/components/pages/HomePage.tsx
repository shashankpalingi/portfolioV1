...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#212121] text-[#F2E3CF] font-sans selection:bg-[#E35342] selection:text-white overflow-x-hidden">
      ...
      {/* --- Hero Section --- */}
      <section className="relative min-h-[90vh] flex items-center justify-center py-20 px-4 md:px-8">
        {/* Background Doodles Pattern */}
        <div className="absolute inset-0 opacity-10 pointer-events-none select-none overflow-hidden">
          <div 
            className="absolute inset-0" 
            style={{ 
              backgroundImage: `url('https://static.wixstatic.com/media/bc7755_f1933ee8f44443b69977904b940c0b67~mv2.png')`,
